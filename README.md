...
## Оценка разработанного сервиса (Streamlit приложения):

1. Приложение достаточно удобно в использовании. Есть боковое меню для выбора необходимого действия (предсказание, просмотр графиков и т.д.);
2. Многие графики удалось визуализировать достаточно хорошо. Возможно стоит добавить ещё несколько полезных и интерактивных графиков;
3. Ограничения: для предсказания стоимости допустимы только определенные характеристики (признаки) авто, которые были использованы для обучения модели;
4. Улучшения планируемые в следующей итерации: добавление в модель оставшихся категориальных признаков, улучшение качества модели за счет фич-иинжиниринга, добавление новых графиков.
